...
>
  ...
  onMouseEnter={(e) => (e.currentTarget.style.color = '#b3783b')}
  onMouseLeave={(e) => (e.currentTarget.style.color = '#c78e44')}
>
  ...
  <div className="md:hidden absolute top-full left-0 w-full bg-white/90 backdrop-blur-lg shadow-lg flex flex-col py-4 px-6 space-y-4 animate-slide-down">
    {navLinks.map((link) => (
      <Link
        ...
        style={{
          color: location.pathname === link.path ? '#c78e44' : '#333',
          backgroundColor: location.pathname === link.path ? '#fef3e6' : 'transparent',
        }}
        onMouseEnter={(e) => (e.currentTarget.style.color = '#b3783b')}
        onMouseLeave={(e) => {
          e.currentTarget.style.color = location.pathname === link.path ? '#c78e44' : '#333';
        }}
      >
        {link.name}
      </Link>
